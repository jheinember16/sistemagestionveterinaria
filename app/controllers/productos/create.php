...
(codigo,nombre_producto,descripcion,stock,stock_minimo,stock_maximo,precio_compra,precio_venta,fecha_de_ingreso,imagen,id_usuario,fyh_creacion,fyh_actualizacion)
VALUES (:codigo,:nombre_producto,:descripcion,:stock,:stock_minimo,:stock_maximo,:precio_compra,:precio_venta,:fecha_de_ingreso,:imagen,:id_usuario,:fyh_creacion,:fyh_actualizacion)');
...
if ($sentencia->execute()) {
    session_start();
    $_SESSION['mensaje'] = "Se registró el producto exitosamente";
